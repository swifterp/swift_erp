...
%>
		<a class="roomlist" onclick="createRoom('<%= String.valueOf(lst.get(i).get("CHATROOM_CODE")) %>', '<%= String.valueOf(lst.get(i).get("CHATROOM_NAME")) %>')"><%= String.valueOf(lst.get(i).get("CHATROOM_NAME")) %></a>
<%
	}
%>
</div>