...
<body>
	...
	<div class="container">
		...
		<div class="contents" style="vertical-align: middle;">
			<a class="btn btn-primary" href="#" style="width: 150px">출/퇴근 기록부</a>
			<a class="btn btn-default" href="Work_write.jsp" style="width: 150px">출/퇴근 작성</a>
			<table id="calendar" border="3" class="table line2" > 
				<thead>
					<tr>
					<!-- 이번년도. 월 -->
